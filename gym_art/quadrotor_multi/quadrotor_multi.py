...
class QuadrotorEnvMulti(gym.Env):
    def __init__(self,
                 ...
                 local_metric='dist', local_coeff=0.0, use_replay_buffer=False, viz_vector_render_type=None,
                 viz_draw_paths=False):
    ...
    def init_scene_multi(self):
        ...
        self.scene = Quadrotor3DSceneMulti(
            ...
            viz_vector_render_type=self.viz_vector_render_type, viz_draw_paths=self.viz_draw_paths
        )
