...
class Multi_Obstacles():
    def __init__(self, mode='None', num_obstacles=0, max_init_vel=1., init_box=2.0, mean_goals=2.0,
    ...
    def step(self, obs=None, quads_pos=None, quads_vel=None, set_obstacles=False):
        # Generate force, mimic force between election, F = k*q1*q2 / r^2,
